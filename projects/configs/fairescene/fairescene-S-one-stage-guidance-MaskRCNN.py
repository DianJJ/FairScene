work_dir = 'work_dirs/fairescene-S-MaskRCNN-semantickitti'
_base_ = [
...
model = dict(
   ...
   pts_bbox_head=dict(
       ...
       pts_header_dict=dict(
           ...
           guidance=False,
           nbr_classes=1),
       seg_header_dict=dict(
           config_path='projects/configs/_base_/mask-rcnn_r50_fpn_ms-poly-3x_coco.py',
           checkpoint_path='ckpts/mask_rcnn_r50_fpn_mstrain-poly_3x_coco_20210524_201154-21b550bb.pth'),
       CE_ssc_loss=True,
