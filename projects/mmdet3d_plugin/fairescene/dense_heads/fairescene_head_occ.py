...
from projects.mmdet3d_plugin.fairescene.utils.ssc_loss import BCE_ssc_loss

@HEADS.register_module()
class FairSceneOccHead(nn.Module):
    def __init__(
        self,
        *args,
        alpha=0.54,
        ...
        **kwargs
        ...
        self.seg_head_1_2 = SegmentationHead(1, 16, self.nbr_classes, [1, 2, 3], guidance=guidance)
        #self.seg_head_1_2 = SegmentationHead(1, 12, self.nbr_classes, [1, 2, 3], guidance=guidance)
    ...
    def save_pred(self, img_metas, y_pred):
        ...
        # save predictions
        pred_folder = os.path.join("./fairescene", "sequences", img_metas[0]['sequence_id'], "predictions")
